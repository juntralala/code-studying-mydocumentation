...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <p class="col-lg-10 fs-4">by <a target="_blank" href="https://www.programmerzamannow.com/"><?= $model['title'] ?? "" ?></a></p>
        </div>
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="/users/profile">
                ...
                <div class="form-floating mb-3">
                    <input name="name" type="text" class="form-control" id="name" placeholder="name" value="<?= $model['user']['name'] ?? $_POST['name'] ?? '' ?>">
