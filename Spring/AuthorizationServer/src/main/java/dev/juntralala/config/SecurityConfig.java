...
public class SecurityConfig {
    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http) throws Exception {
        OAuth2AuthorizationServerConfigurer authConfig = OAuth2AuthorizationServerConfigurer.authorizationServer();

        return http
                .securityMatcher(authConfig.getEndpointsMatcher())
                .with(authConfig, (authorizationServer) -> authorizationServer.oidc(Customizer.withDefaults()))
