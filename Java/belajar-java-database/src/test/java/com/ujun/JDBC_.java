 ...
 * JDBC tidak bisa langsung digunakan, karena isisnya hanyalah interface-interface kontrak untuk berinterasi dengan DB
 * JDBC perlu implementasi, aytau kita sebut dengan Driver, seperti MySQL Driver, PostgreSQl Driver, OracleDB Driver DLL
